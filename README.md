About sphinxcontrib-srclinks-feedstock
======================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sphinxcontrib-srclinks-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/westurner/sphinxcontrib-srclinks

Documentation: https://pypi.python.org/pypi/sphinxcontrib-srclinks
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3577&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sphinxcontrib-srclinks-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sphinxcontrib-srclinks` can be installed with `conda`:
...
```
mamba install sphinxcontrib-srclinks
```

It is possible to list all of the versions of `sphinxcontrib-srclinks` available on your platform with `conda`:
...
```
mamba search sphinxcontrib-srclinks --channel conda-forge
```
...
mamba repoquery search sphinxcontrib-srclinks --channel conda-forge

# List packages depending on `sphinxcontrib-srclinks`:
mamba repoquery whoneeds sphinxcontrib-srclinks --channel conda-forge

# List dependencies of `sphinxcontrib-srclinks`:
mamba repoquery depends sphinxcontrib-srclinks --channel conda-forge
```
